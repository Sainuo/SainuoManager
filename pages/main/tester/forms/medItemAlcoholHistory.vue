...
export default {
    ...
    methods: {
        loadData(){
            var me=this;
            axios.get(apiConfig.medItemAlcoholHistory_get,{ params:{ id:me.id}}).then(response=>{
        ...
        onConfirm() {
            ...
            me.$refs.ruleForm.validate((valid) => {
                if (valid) {
                    var me = this;
                    axios.put(apiConfig.medItemAlcoholHistory_put,utility.toServerModel(me.ruleForm)).then(response=>{
